...
namespace petstore.webservices {
    ...
    export class PetClient implements IPetClient {
        ...
        constructor (private $http: ng.IHttpService, private $q: ng.IQService, private config: app.IConfig) {
        }
            ...
            return new this.$q<any>(
                (resolve: ng.IQResolveReject<any>, reject: ng.IQResolveReject<any>) => {
                    this.$http<any>( {
                        method: 'POST',
                        data: body,
                        url: buildServiceUrl(this.config.baseUrl, resourceUrl)
        ...
        public findPetsByStatus(status: string[]): ng.IPromise<__models.Pet[]> {
            ...
            return new this.$q<__models.Pet[]>(
                (resolve: ng.IQResolveReject<__models.Pet[]>, reject: ng.IQResolveReject<any>) => {
                    this.$http<__models.Pet[]>( {
                        method: 'GET',
                        url: buildServiceUrl(this.config.baseUrl, resourceUrl, queryParams)
                    }).then((response: ng.IHttpPromiseCallbackArg<__models.Pet[]>) => {
                        resolve(response.data);
                    }).catch((response: ng.IHttpPromiseCallbackArg<any>) => {
                        reject(response.data);
                    });
        ...
        public uploadFile(petId: number, additionalMetadata?: string, file?: any): ng.IPromise<__models.ApiResponse> {
            ...
            let resourceUrl: string = '/pet/{petId}/uploadImage'
                .replace('{petId}', encodeURIComponent('' + petId));
            return new this.$q<__models.ApiResponse>(
                (resolve: ng.IQResolveReject<__models.ApiResponse>, reject: ng.IQResolveReject<any>) => {
                    ...
                    this.$http<__models.ApiResponse>( {
                        ...
                        url: buildServiceUrl(this.config.baseUrl, resourceUrl)
                    }).then((response: ng.IHttpPromiseCallbackArg<__models.ApiResponse>) => {
                        resolve(response.data);
                    }).catch((response: ng.IHttpPromiseCallbackArg<any>) => {
                        reject(response.data);
                    });
